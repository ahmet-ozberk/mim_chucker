...
import '../screens/mim_detail_screen.dart';
    ...
    return OverlayEntry(
      builder: (context) {
        ...
        final statusCodeColor =
            MimChuckerUtils.getStatusCodeColor(apiResponse.statusCode);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            MimChuckerUtils.getReadableDuration(
        ...
        builder: (context) {
          ...
          return ProviderScope(
            child: ShadTheme(
              ...
              child: MimDetailScreen(apiResponse: apiResponse),
            ),
          );
        },
      ),
