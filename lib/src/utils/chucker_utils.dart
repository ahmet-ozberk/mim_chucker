...
/// Utility class for MimChucker
class MimChuckerUtils {
...
/// Navigator observer for MimChucker
class _MimChuckerNavigatorObserver extends NavigatorObserver {
  @override
  ...
  void _initializeOverlay() {
    if (navigator?.overlay != null) {
      NotificationService.setOverlayState(navigator!.overlay!);
    }
  }
}
